...
function LineChart({
  allow_decimals = true, data, idx, labels = true, line_width = 5, note = false, show_first_label = true, source, subtitle = false, suffix = '', title, xlabel = '', ymax = undefined, ymin = undefined, ystep = 1
}) {
